/*  MCP23017 library for STM32CubeMX
    ...
    Modified by Tommaso Sabatini <algol6555.gmail.com> for use on the STM32CubeMX platform
...
#define MASTER1_IODIRA		((uint8_t)0xFF)			// IO7 - IO6 - IO5 - IO4 - IO3 - IO2 - IO1 - IO0
...
#define MASTER1_GPINTENA 	((uint8_t)0xFF) 		// GPINT7 - GPINT6 - GPINT5 - GPINT4 - GPINT3 - GPINT2 - GPINT1 - GPINT0
#define MASTER1_GPINTENB 	((uint8_t)0xFF) 		// GPINT7 - GPINT6 - GPINT5 - GPINT4 - GPINT3 - GPINT2 - GPINT1 - GPINT0 
#define MASTER1_DEFVALA 	((uint8_t)0x00)			// DEF7 - DEF6 - DEF5 - DEF4 - DEF3 - DEF2 - DEF1 - DEF0
...
#define MASTER1_GPPUA 		((uint8_t)0xFF)			// PU7 - PU6 - PU5 - PU4 - PU3 - PU2 - PU1 - PU0
...
#define MASTER2_IODIRA		((uint8_t)0xFF)			// IO7 - IO6 - IO5 - IO4 - IO3 - IO2 - IO1 - IO0
...
#define MASTER2_IPOLB 		((uint8_t)0x00)			// IP7 - IP6 - IP5 - IP4 - IP3 - IP2 - IP1 - IP0			
#define MASTER2_GPINTENA 	((uint8_t)0xFF) 		// GPINT7 - GPINT6 - GPINT5 - GPINT4 - GPINT3 - GPINT2 - GPINT1 - GPINT0
#define MASTER2_GPINTENB 	((uint8_t)0xFF) 		// GPINT7 - GPINT6 - GPINT5 - GPINT4 - GPINT3 - GPINT2 - GPINT1 - GPINT0 
#define MASTER2_DEFVALA 	((uint8_t)0x00)			// DEF7 - DEF6 - DEF5 - DEF4 - DEF3 - DEF2 - DEF1 - DEF0
#define MASTER2_DEFVALB 	((uint8_t)0x00)			// DEF7 - DEF6 - DEF5 - DEF4 - DEF3 - DEF2 - DEF1 - DEF0
#define MASTER2_INTCONA 	((uint8_t)0x00)  		// IOC7 - IOC6 - IOC5 - IOC4 - IOC3 - IOC2 - IOC1 - IOC0
#define MASTER2_INTCONB 	((uint8_t)0x00)  		// IOC7 - IOC6 - IOC5 - IOC4 - IOC3 - IOC2 - IOC1 - IOC0
...
#define MASTER2_GPPUA 		((uint8_t)0xFF)			// PU7 - PU6 - PU5 - PU4 - PU3 - PU2 - PU1 - PU0
...
#define MASTER2_GPIOA 		((uint8_t)0x00)			// GP7 - GP6 - GP5 - GP4 - GP3 - GP2 - GP1 - GP0
#define MASTER2_GPIOB 		((uint8_t)0x00)			// GP7 - GP6 - GP5 - GP4 - GP3 - GP2 - GP1 - GP0
#define MASTER2_OLATA 		((uint8_t)0x00)			// OL7 - OL6 - OL5 - OL4 - OL3 - OL2 - OL1 - OL0
